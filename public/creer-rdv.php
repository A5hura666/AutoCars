        ...
        <section>
            <section class="createrdv">
                <div class="client">
                    <section>
                        <h3>Client</h3>
                        <input type="text" class="usersearchbar" placeholder="Recherche un client" list="clientlist" onchange="select_client()" required>
                ...
                <form class="createrdv" method="post" onchange="submit()">
                    ...
                    <div>
                        ...
                        <input type="text" name="operator" class="operatorsearchbar" placeholder="Ajoutez un operator" list="operatorlist" <?php if (isset($_SESSION['operator'])) {
                                                                                                                                                echo 'value="' . $_SESSION['operator'] . '"';
                                                                                                                                            } ?>>
                    ...
                    <div>
                        ...
                        <input type="date" name="dateestime" id="dateestime" <?php if (isset($_SESSION['dateestime'])) {
                                                                                    echo 'value="' . $_SESSION['dateestime'] . '"';
                                                                                } ?>>
                    </div>
                    <div>
                        <label>kilometrage actuel</label>
                        <input type="number" step="0.01" name="km_actu" id="Km_actu" <?php if (isset($_SESSION['km_actu'])) {
                                                                                            echo 'value="' . $_SESSION['km_actu'] . '"';
                                                                                        } ?>>
                    </div>
                    <div class="btn">
